...
Description: SendX is a lightweight marketing automation platform which helps to grow your web business. Installing this plugin will provide you various widgets like hello bars, popups, sliders, modals etc. which you can use to convert your visitors to blog subscribers. 
Version: 1.0.0
Author: SendX
